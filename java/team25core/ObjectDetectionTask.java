...
public class ObjectDetectionTask extends RobotTask {
    ...
    public static final String LABEL_OBJECT1 = "Object1";
    private static final String LABEL_OBJECT2 = "Object2";
    ...
    private void initTfod(HardwareMap hardwareMap)
    {
        ...
        tfod.loadModelFromAsset(TFOD_MODEL_ASSET, LABEL_OBJECT1, LABEL_OBJECT2);
    }
...
//        }
    ...
    public static ObjectKind isObject(Recognition object)
    {
        if (object.getLabel().equals(LABEL_OBJECT1)) {
            ...
            return ObjectKind.OBJECT2_KIND;
        } else {
